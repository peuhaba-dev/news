      ...
      <form action={handleSubmit} className="space-y-5 bg-white border border-border rounded-xl p-5 sm:p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            {loadingCats ? <div className="w-full border border-border rounded-md px-3.5 py-2.5 text-[14px] text-ink-soft bg-gray-50 animate-pulse">Memuat...</div> :
        ...
        <div>
          ...
          <textarea name="content" required rows={14} placeholder="<p>Tulis konten artikel di sini...</p>"
