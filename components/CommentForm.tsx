...
export default function CommentForm({ postId }: CommentFormProps) {
  ...
  return (
    <div className="mt-10 pt-8 border-t border-border">
      <h3 className="font-head text-[20px] font-bold text-ink mb-5">
        Tinggalkan Komentar
      </h3>

      {status === 'success' && (
        <div className="bg-aceh-green-light border border-aceh-green/30 rounded-md px-4 py-3
                        text-[13px] text-aceh-green-dark font-semibold mb-5">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <p className="text-[12px] text-ink-soft">
          Komentar akan ditampilkan setelah melewati proses moderasi.
        </p>
