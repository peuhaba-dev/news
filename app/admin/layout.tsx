    ...
    <div className="min-h-screen bg-surface flex">
      ...
      <aside className="w-56 bg-[#111827] text-white shrink-0 flex flex-col">
        <div className="px-5 py-4 border-b border-white/10">
          <Link href="/" className="font-label text-[16px] font-bold text-aceh-green tracking-[0.5px]">
            Berita Meureno
          </Link>
          <p className="text-[10px] text-white/40 mt-0.5 uppercase tracking-wider">Admin Panel</p>
        </div>
